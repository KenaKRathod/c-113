...
print(f"median of savings - {statistics.mode(all_savings)}")
...
print(f"standard deviation of people who were reminded to save -> {statistics.stdev(reminded_savings)}")
print(f"standard deviation of people who were not reminded to save -> {statistics.stdev(not_reminded_savings)}")
